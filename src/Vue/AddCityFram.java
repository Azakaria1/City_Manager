...
public class AddCityFram extends JPanel {
    ...
    void initLabels(){
        lbl_title=new JLabel("Add New City Form");
    ...
    void initActionListener(){
        btn_confirm.addActionListener(e->{
            ...
            int id =villes.size() ;
            ville.setId(id +1);
            ville.setNom(txt_nom.getText().trim());
            ville.setPopulation(Long.parseLong(txt_population.getText().trim()));
            ville.setRegion(txt_region.getText().trim());

            serviceVille.ajouterVille(ville);
